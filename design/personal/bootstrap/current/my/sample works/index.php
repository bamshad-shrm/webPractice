...
<html>
	...
	<body>
		...
		<div id=WebDevelpment>
			...
			<h2>Practical categories</h2>
			<div><a class= "sample_links" href="web/personal/">Personal</a></div>
			<h2>Aspects</h2>
			<div><a class= "sample_links" href="web/db/">Database</a></div>
			<div><a class= "sample_links" href="web/design/">Design</a></div>
			<h2>Frameworks</h2>
			<h4>Laravel</h4>
			<p>Laravel is a php framework that supply self-sufficient development environment. I have installed and tested some of it's functionalities.</p>
			<p>In <a href="http://bamshad-shm.com/laravelTest" target="_blank">this link</a> you can see my learning steps. It also inlcudes some practical tutorilas.</p>
			<h2>Platforms</h2>
			<h4>OpenCart</h4>
			...
			<a class= "sample_links" href="http://bamshad-shm.com/my/sample%20works/web/openCart/upload/" target="_blank">An online OpenCart store sample.</a>
			<h4>WordPress</h4>
			<p>"WordPress is a free and open-source content management system (CMS) based on PHP and MySQL".</p>
			<a class= "sample_links" href="http://bamshad-shm.com/my/sample%20works/web/wordpress/" target="_blank">A simple WorldPress page.</a>
		</div>
