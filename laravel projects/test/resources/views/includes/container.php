<div class="jumbotron">
	<div class="container text-center">
		...
		<h2>6. Database</h2>
            <div class="links">
				<p>Click <a href="http://localhost/web/laravel%20projects/test/public/db/" target="_blank">here</a> to see a simple example. In this sample database, a list of Laravel tutorials is placed in a mySQL table. To build the db and shows it's content, I followed the steps in <a href="https://laravel-news.com/your-first-laravel-application" target="_blank">this</a> link. </p>
            </div>
