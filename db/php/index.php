...
<html>
	...
	<body>
		...
		<?php
				...
				echo "<table>";
					...
					while($row = $result->fetch_assoc()) {
							...
							echo "<tr>";
								...
								echo "<label>Name:</label><input type='text' name='firstName' size='8'  maxlength='15' value=".$row["firstName"]."><br>";
								echo "<label>Family:</label><input type='text' name='lastName' size='8'  maxlength='30' value=".$row["lastName"]."><br>";
			...
			echo "<label>Name:</label><input type='text' name='firstName'  maxlength='15' size='8'><br>";
			echo "<label>Family:</label><input type='text' name='lastName'  maxlength='30' size='8'><br>";
			echo "<input type='submit' value='Submit'>";
