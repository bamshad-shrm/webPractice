...
<html>
	...
	<body>
		...
		<?php
				...
				echo "<table>";
					...
					while($row = $result->fetch_assoc()) {
							...
							echo "<tr>";
								...
								echo "<label>Name:</label><input type='text' name='name' size='8' value=".$row["User Name"]."><br>";
								echo "<label>Family:</label><input type='text' name='family' size='8' value=".$row["User Family"]."><br>";
								...
								";
								echo "<td id='reload'> " . $row["User Name"]. " </td>";
								echo "<td id='reload'> " . $row["User Family"]. " </td>";
							echo "</tr>";
							echo "
								<script>
									$(document).ready(function(){
										// load text file when page loads
										$('#reload').load(window.index.php.href + ' #reload');
			...
			echo "<label>Name:</label><input type='text' name='name' size='8'><br>";
			echo "<label>Family:</label><input type='text' name='family' size='8'><br>";
			echo "<input type='submit' value='Submit'>";
